...
//        /***
//         * Testing Emotiv status data sample
//         */
...
//                            EmoState.IEE_InputChannels_t.IEE_CHAN_AF3.getType()) + ", ");
//                    System.out.print(EmoState.INSTANCE.IS_GetContactQuality(eState,
//                            EmoState.IEE_InputChannels_t.IEE_CHAN_T7.getType()) + ", ");
//                    System.out.print(EmoState.INSTANCE.IS_GetContactQuality(eState,
//                            EmoState.IEE_InputChannels_t.IEE_CHAN_Pz.getType()) + ", ");
//                    System.out.print(EmoState.INSTANCE.IS_GetContactQuality(eState,
//                            EmoState.IEE_InputChannels_t.IEE_CHAN_T8.getType()) + ", ");
//                    System.out.println(EmoState.INSTANCE.IS_GetContactQuality(eState,
//                            EmoState.IEE_InputChannels_t.IEE_CHAN_AF4.getType()) + ", ");
//                }
